...
namespace FlyByWireless.XPLM
{
    ...
    public static class Plugin
    {
        ...
        {
            [DllImport(Defs.Lib)]
            static extern void XPLMGetPluginInfo(int id, ref byte name, ref byte filePath, ref byte signature, ref byte description);
            ...
            XPLMGetPluginInfo(id,
                ref MemoryMarshal.AsRef<byte>(name),
                ref MemoryMarshal.AsRef<byte>(filePath),
                ref MemoryMarshal.AsRef<byte>(signature),
                ref MemoryMarshal.AsRef<byte>(description)
            );
